...
class ListaOCS extends Component {
  constructor(props) {
    super(props);
  ...
  render() {
    return (
      ...
      <Card>
      <CardHeader>
      <i className="fa fa-align-justify"></i><strong>Lista OCS</strong><small className="text-muted"> Exportacion OCS</small>
              ...
              <tbody>
                ...
                <br></br>
                  <Row>
                    <Col xs="12" sm="6">
                    <center>
                    <Link to="/exportacion/detalle-ocs"className="btn btn-primary btn-lg"block>Continuar</Link>
                     </center>
                    </Col>
                    <Col xs="12" sm="6">
                    <center>
