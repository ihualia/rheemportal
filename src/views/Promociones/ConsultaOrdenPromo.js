...
class ConsultaOrdenPromo extends Component {
  constructor(props) {
    super(props);
  ...
  render() {
    return (
      ...
      <Card>
      <CardHeader>
      <i className="fa fa-align-justify"></i><strong>ConsultaOrden</strong><small className="text-muted"> Aprobaciones Promo</small>
              ...
              <tbody>
                ...
                <br></br>
                  <Row>
                    <Col xs="12" sm="6">
                    <center>
                    <Link to="/promociones/aprobacion-ordenPromo"className="btn btn-primary btn-lg"block>Continuar</Link>
                     </center>
                    </Col>
                    <Col xs="12" sm="6">
                    <center>
...
export default ConsultaOrdenPromo;